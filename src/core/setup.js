  ...
  try {
    ...
    const setupType = await select({
      ...
      choices: [
        ...
        {
          name: "Prebuilt (FkVim, LazyVim, NVChad, LunarVim)",
          value: "prebuilt",
        },
    ...
    if (setupType !== "prebuilt") {
      console.log(
        chalk.blueBright(
          "⚠️ Minimal flow is not implemented yet — coming soon!\n",
        ),
      );
      return;
    }
    ...
    console.log(
      chalk.gray(
        "- If something failed, open Neovim and run :Lazy sync or check logs.\n",
      ),
    );
